                            ...
                            <form id="add_po_form" autocomplete="off" action="#">
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-8">
                                        ...
                                        <input type="text" class="form-control form-control-sm"  id="po_owner" name="po_owner" value="<?php echo $session_user; ?>" readonly class="form-control form-control-sm"  required />
...
<option selected>Open Shipping Via</option>
                                    ...
                                    <div class="form-group col-md-4">											
                                        ...
                                        <input type="text" class="form-control form-control-sm" id="po_shippingvia" name="po_shippingvia" required autocomplete="off">
...
<option selected>Open Location</option>
                                    ...
                                    <div class="form-group col-md-4">											
                                        <label for="inputState">Delivery At<span class="text-danger">*</span></label>
                                        <input type="text" class="form-control form-control-sm" id="po_deliveryat" name="po_deliveryat" required autocomplete="off">
                                ...
                                <table  class="table table-hover small-text" id="tb">
                                    ...
                                    <tr>
                                        <td>
                                            <select name="itemcode" class="form-control itemcode" onchange="rowitem.set_itemrow(this,'purchase','po');" id="item_select">
                                        ...
                                        <td><input id="qty" type="text" name="qty" onkeypress="rowitem.update_math_vals('po');"   onkeyup="rowitem.update_math_vals('po');" placeholder="Qty" data-id="" class="form-control qty"></td>                                        <td>
                                        <select class="form-control amount" id="uom"  onchange="rowitem.update_math_vals('po');"; name="uom" style="line-height:1.5;">
                                        ...
                                        <td><input id="price" type="text" name="price" placeholder="Rate/Qty" onkeypress="rowitem.update_math_vals('po');"   onkeyup="rowitem.update_math_vals('po');"   data-id="" class="form-control price"></td>
                                    ...
                                    <div class="col-md-5">
                                            ...
                                            <div class="row">
                                                <div class="col-md-8">
                                                    ...
                                                    <div id="ember1600" class="input-group ember-view col-md-7" style="padding-left:0px;">
                                                        <input type="text" class="form-control text-right ember-text-field text-right ember-view" id="podiscount" style=".375rem .75rem;" onkeypress="rowitem.update_math_vals('po');"   onkeyup="rowitem.update_math_vals('po');" placeholder="Discount"> 
                                        ...
                                        <div class="col-md-12">
                                            <div class="row">
                                                ...
                                                <div class="col-md-4 text-right">
                                                <span style="font-weight:600;"  class="lead text-danger" id="pograndtotal">--</span>
                                              </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-8">												
                                                    <div class="form-group col-8" style="padding-left:0px;">
                                                        ...
                                                        <input class="form-control" onkeypress="rowitem.update_math_vals('po');"   onkeyup="rowitem.update_math_vals('po');" id="poadjustmentval" type="number" step="any" placeholder="Adjustment ">
                                ...
                                <div class="form-row col-md-8">
                                    <div class="form-group col-md-12">
                                        <textarea rows="2" class="form-control" name="po_tc"  id="po_tc" placeholder="terms and conditions" >
                                        </textarea>
                                    </div>
                                </div>
...
<script>       
    ...
    $(function(){
        ...
        var lasttc = Page.get_lasttc('purchaseorders');
        $('#po_tc').val(lasttc);
