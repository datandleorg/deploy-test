...
<div class="content-page">
                    ...
                    <div class="card mb-3">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table id="example143" class="table table-bordered table-hover display">
                                    <thead>
                                        <tr>
  ...
  <div class="dropdown-menu">
    <a class="dropdown-item"  href="#" onclick="printContent(this);" data-template="sales_credit_inv" data-code="'.$row['inv_code'].'" data-img="assets/images/logo.jpg"  data-id="po_print"><i class="fa fa-print" aria-hidden="true"></i>&nbsp; Print</a>   <a class="dropdown-item"  href="#" onclick="printContent(this);" data-template="dc_print" data-code="'.$row['inv_code'].'" data-img="assets/images/logo.jpg"  data-id="po_print"><i class="fa fa-print" aria-hidden="true"></i>&nbsp; DC Print</a>';
