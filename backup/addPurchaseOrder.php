...
<i class="fa fa-user-plus" aria-hidden="true"></i>Add New Pay Term</a-->
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-8">									
                                        ...
                                        <input type="text" class="form-control form-control-sm" id="po_freight" name="po_freight" required placeholder="To-Pay or Pay-To" autocomplete="off">
                                    </div>
                                </div>
                                    ...
                                    <tr>
                                        ...
                                        window.location.href = 'addPurchaseOrder.php?supcode='+supcode;*/
                                            ...
                                            function post_itemrow(ele,vals){
                                                ...
                                                $(ele).closest('tr').find('#price').val(price.toFixed(2));
