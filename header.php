                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td class="text-left"><a  href="listPurchaseItemMaster.php">
                                                            <i class="fa fa-plus bigfonts" aria-hidden="true">&nbsp;Inventory(Inward) Item Master</i></a></td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-left"><a  href="listSalesItemMaster.php">
                                                            <i class="fa fa-plus bigfonts" aria-hidden="true">&nbsp;Inventory(Outward) Item Master</i></a></td>
               ...
               <!--li class="list-inline-item dropdown notif">
                ...
                <li class="list-inline-item dropdown notif">
                    ...
                    <div class="dropdown-menu dropdown-menu-right dropdown-arrow dropdown-arrow-success dropdown-lg">
                        ...
                        <!-- All-->
                        <a  href="http://e-schoolz.in" class="dropdown-item notify-item notify-all">
                        ...
                        <ul class="list-unstyled">
                            ...
                            <li class="submenu">
                                ...
                                <ul class="list-unstyled">								
                                    ...
                                    <!--li><a href="addInvoice2.php"><b><i class="fa fa-plus-circle"></i>Manual Invoice</b></a></li-->						
