            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="breadcrumb-holder">
                        <h1 class="main-title float-left"> Payment Transactions Report</h1>
                        <ol class="breadcrumb float-right">
                            <li class="breadcrumb-item">Home</li>
                            <li class="breadcrumb-item active">Payment Transactions Reprot</li>
                        </ol>
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                    <div class="card mb-3">
                        <div class="card-header">
                            ...
                            <h3><i class="fa fa-cart-plus bigfonts" aria-hidden="true"></i><b>&nbsp;Payment Transactions Report </b></h3>
                        </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="form-group col-md-3">
                                    <select id="partywise" class="form-control form-control-sm" name="partywise">
                                        ...
                                        <?php
                                        $sql = mysqli_query($dbcon,"SELECT * FROM recordpayments");
                                    ...
                                    <table id="po_reports" class="table table-bordered" style="width:100%">
                                        ...
                                        <tbody>
                                            ...
                                            if((isset($_GET['st'])&&$_GET['st']!='')||(isset($_GET['end'])&&$_GET['end']!='')||(isset($_GET['partywise'])&&$_GET['partywise'])){
                                                ...
                                                $sql = "SELECT * from recordpayments p where 1=1 ";
                                                if($_GET['st']!=''){
                                                    if($st==$end){
                                                        $sql.= " and p.date='$st' ";   
                                                    }else{
                                                        $sql.=" and (p.date BETWEEN '$st' AND '$end') ";   
                                                    }
                                                }
                                                if(isset($_GET['partywise'])&&$_GET['partywise']!=''){
                                                    // echo $_GET['vendorwise'];
                                                    $sql.=" and p.partyname='".$_GET['partywise']."'";    
                                                }

                                                $sql.=" ;"; 

                                            }else{
                                                $sql = "SELECT * from recordpayments ;";    
                                            }
...
<script>
            ...
            buttons: [
                {
                    ...
                    customize: function ( win ) {
                        $(win.document.body)
                            .css( 'font-size', '10pt' )
                            .prepend(
                            '<p><img src="<?php echo $baseurl;?>assets/images/dhirajLogo.png" style="width:50px;height:50px;" /></p><p class="lead text-center"><b>Payment Transactions</b><br/></p>'+printhead+'</div>'
                        );
    ...
    function get_po_reports(){
        ...
        location.href="listRecordPayments.php?st="+st+"&end="+end+"&partywise="+partywise;
