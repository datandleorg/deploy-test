            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="breadcrumb-holder">
                        <h1 class="main-title float-left">Inventory Adjustment(Inward) Log Report</h1>
                        <ol class="breadcrumb float-right">
                            <li class="breadcrumb-item">Home</li>
                            <li class="breadcrumb-item active">Inventory Adjustment(Inward) Log Report</li>
                        </ol>
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                    <div class="card mb-3">
                        <div class="card-header">
                            ...
                            <h3><i class="fa fa-cart-plus bigfonts" aria-hidden="true"></i><b>&nbsp;                             
                                Inventory Adjustment(Inward) Log Report </b></h3>
                                        ...
                                        <tbody>
                                            <?php
                                               ...
                                               // $sql = "SELECT * from purchaseitemlog where 1=1";
                                                $sql = "SELECT itemcode,itemname,qtyadjusted,qtyonhand,concat(qtyonhand-qtyadjusted)as oldqty ,uom,adjustedon,handler,notes,id FROM purchaseitemlog where";   
                                                ...
                                                if($_GET['st']!=''){
                                                    ...
                                                    $sql = "SELECT itemcode,itemname,qtyadjusted,qtyonhand,concat(qtyonhand-qtyadjusted)as oldqty ,uom,adjustedon,handler,notes,id FROM purchaseitemlog ORDER BY id DESC ;";   
                                                }
                                                //echo $sql; 
...
var date_range = $('#daterange').val(); 
        var printhead = '';
        //var printhead = 'Inventory Adjustment(Inward) Log Report';
        printhead+= date_range!=''?'<p><b>Date : </b>'+date_range+'</p>':'';
		
        var excel_printhead = 'Inventory Adjustment(Inward) Log Report';
            ...
            buttons: [
                {
                    ...
                    customize: function ( win ) {
                        $(win.document.body)
                            .css( 'font-size', '10pt' )
                            .prepend(
                            '<p><img src="<?php echo $baseurl;?>assets/images/dhirajLogo.png" style="width:50px;height:50px;" /></p><p class="lead text-center"><b>Dhiraj Agro Private Limited <br>Inventory Adjustment(Inward) Log Report</b><br/></p>'+printhead+'</div>'
                        );
				...
				//Krishna issue fixed 3-2-2018
                {
                    extend: 'excel',
                    text:'<span class="fa fa-file-excel-o"></span>',
                    title:'Inventory Adjustment(Inward) Log Report', footer: true,
                    messageTop: ''   
   ...
   function get_po_reports(){
       ...
       // var pstatuswise = $('#pstatuswise').val();
        location.href="inventAdjInwardReport.php?st="+st+"&end="+end;/*+"&vendorwise="+vendorwise+"&pstatuswise="+pstatuswise;*/
