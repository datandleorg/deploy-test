                                    ...
                                    <table id="po_reports" class="table table-bordered" style="width:100%">
                                        ...
                                        <tbody>
                                            ...
                                            if((isset($_GET['st'])&&$_GET['st']!='')||(isset($_GET['end'])&&$_GET['end']!='')||(isset($_GET['custwise'])&&$_GET['custwise'])||(isset($_GET['pstatuswise'])&&$_GET['pstatuswise']!='')){ 
                                                ...
                                                $sql = "SELECT * from invoicesacc i,customerprofile c where 1=1  ";
                                                if($_GET['st']!=''){
                                                    if($st==$end){
                                                ...
                                                $sql.=" and i.inv_customer=c.custid and i.inv_balance_amt>0;";    
                                                 ...
                                                 $sql = "SELECT * from invoicesacc i,customerprofile c where i.inv_customer=c.custid and i.inv_balance_amt>0;";    
                                            }
...
<script>
    ...
    function get_custrec_reports(){
        ...
        location.href="CustomerReceivablesReportsacc.php?st="+st+"&end="+end+"&custwise="+custwise+"&pstatuswise="+pstatuswise;
